...
\begin{frame}[fragile]\frametitle{Reccursivité}
  ...
  \fbox{\lstinputlisting[firstline=5,lastline=10,language=Python]{../examples/moyenne.py}}
...
\begin{frame}{Tuples}
  ...
  \center{\fbox{\tt t = 1, 42, 'bob', 3.14 }}
  
  Se consulte comme une liste:
  \center{\fbox{\tt nom = t[2] }}
  
  Peut être utilisé pour affecter plusieurs variables:
  \center{\fbox{\tt nom, age = `Bob', 42 }}
  
  Peut être utilisé pour affecter plusieurs variables:
  \center{\fbox{\tt quotient, reste = divmod(42, 7) }}
  
  Peut être mis dans dans des listes:
  \center{\fbox{\tt student=[('Bob', 15), ('Alice', 16), ('Jane',15) ]}}
\end{frame}
